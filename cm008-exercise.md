...
Note that ggplot2's grouping is different from dplyr's! Try making a spaghetti plot of lifeExp over time for each coutry, by piping in a grouped data frame -- it won't work. ggplot will not recognize groupings made with dplyr:
...
``` r
gapminder %>%
  group_by(continent, "Age" = if_else(lifeExp>60, "high", "low")) %>% 
  summarize(md = median(gdpPercap)) %>% 
  arrange(md)
```
...
```
    ...
    ##  6 Asia      Cambodia      -9.10
    ##  7 Africa    Namibia       -7.43
    ##  8 Africa    South Africa  -6.87
    ##  9 Asia      China         -6.05
    ## 10 Africa    Zambia        -5.86
    ## # ... with 132 more rows
...
```
    ...
    ##    <fct>     <fct>     <int>   <dbl>   <int>     <dbl>     <dbl>     <dbl>
    ##  1 Afghanis~ Asia       1952    28.8  8.43e6      779.   1.68e11   6.57e 9
    ##  2 Afghanis~ Asia       1957    30.3  9.24e6      821.   2.12e11   7.59e 9
    ##  3 Afghanis~ Asia       1962    32.0  1.03e7      853.   2.56e11   8.76e 9
    ##  4 Afghanis~ Asia       1967    34.0  1.15e7      836.   3.35e11   9.65e 9
    ##  5 Afghanis~ Asia       1972    36.1  1.31e7      740.   4.23e11   9.68e 9
    ##  6 Afghanis~ Asia       1977    38.4  1.49e7      786.   5.26e11   1.17e10
    ##  7 Afghanis~ Asia       1982    39.9  1.29e7      978.   5.77e11   1.26e10
    ##  8 Afghanis~ Asia       1987    40.8  1.39e7      852.   7.07e11   1.18e10
    ##  9 Afghanis~ Asia       1992    41.7  1.63e7      649.   7.51e11   1.06e10
    ## 10 Afghanis~ Asia       1997    41.8  2.22e7      635.   8.78e11   1.41e10
    ## # ... with 1,694 more rows, and 1 more variable: rel_gdp <dbl>
